...
class Projects_categories extends CIF_Controller {

    public $layout = 'full';
    public $module = 'projects_categories';
    public $model = 'Projects_categories_model';
    ...
    public function index() {
        ...
        $config['base_url'] = site_url('admin/projects_categories/index');
