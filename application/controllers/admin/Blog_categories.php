...
class Blog_categories extends CIF_Controller {

    public $layout = 'full';
    public $module = 'blog_categories';
    public $model = 'Blog_categories_model';
    ...
    public function index() {
        ...
        $config['base_url'] = site_url('admin/blog_categories/index');
