...
class Skills_categories extends CIF_Controller {

    public $layout = 'full';
    public $module = 'skills_categories';
    public $model = 'Skills_categories_model';
    ...
    public function index() {
        ...
        $config['base_url'] = site_url('admin/skills_categories/index');
