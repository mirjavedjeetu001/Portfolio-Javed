...
/**
 * @class: SEO
 * @description: Uniform URLs
 * @author: Muhammad El-Saeed <muhammad@el-saeed.info>
 */
class Seo{
    private $translate_arabic = array(
        "أ" => "a",
        "ا" => "a",
        "آ" => "a",
        "ب" => "b",
    ...
    public function uniform($title = NULL) {
        if( ! $title) return "";
        $title = $this->translate($title);
        return $this->sanitize_title_with_dashes($title);
    }
    
    private function translate($title) {
        return strtr($title, $this->translate_arabic);
    }
    /**
