...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/skills/manage'); ?>" class="btn btn-secondary btn-sm"><i class="fa fa-plus-square" aria-hidden="true"></i> <?php echo lang('global_add_new_record') ?></a>
        </div>
    </div>
            ...
            <table cellspacing="0" class="table table-small-font table-bordered table-striped" >
                ...
                <tbody class="middle-align">
                    <?php foreach ($items as $item): ?>
                        <tr id="<?php echo $item->skill_id ?>">
                            <td><?php echo $item->title ?></td>
                            <td><?php echo $item->category ?></td>
                            <td>
                                <a href="<?php echo site_url('admin/skills/manage/' . $item->skill_id); ?>" class="btn btn-orange btn-sm">
...
<script type="text/javascript">
    $(".remove").click(function () {
        ...
        {
            $.ajax({
                url: '<?php echo site_url() ?>admin/skills/delete/' + id,
                type: 'DELETE',
                error: function () {
